 ...
 * and entity metadata.
 *
 * Extracted from NodeRoom's passive room intelligence and made provider-agnostic.
 ...
 *   - < 0.35 → ignore
 *
 * @param text - Raw text from any source (chat message, document, cell, note)
 * @returns Structured finding with score, action, entities, signals, evidence
 */
